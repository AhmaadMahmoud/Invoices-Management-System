            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="btn ripple btn-primary" href="{{ route('invoice.create') }}">اضافه
                            فواتير</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('editInvoices', [$invoice->id]) }}">
                                        ...
                                        <td></td>
                                        {{-- <td> {{ $invoice->note }} </td> --}}
                                        {{-- <td> <a class="btn btn-danger" href="{{ route('print',["$invoice->id"]) }}">طباعه الفاتوره</a> </td>
                                <td> <a class="btn btn-success" href="{{ route('status',["$invoice->id"]) }}">تغيير حاله الدفع</a> </td> --}}
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    {{-- <a class="dropdown-item" href="{{ route('delete-invoice',["$invoice->id"]) }}"
                                                        data-toggle="modal"
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('delete-invoice',["$invoice->id"]) }}"><i
                                                                class=" text-danger fas fa-money-bill"></i>&nbsp;&nbsp;حذف
                                                            الفاتورة
                                                            </a>
                                                        <a class="dropdown-item" href="{{ route('status',["$invoice->id"]) }}"><i
