                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <h2 class="mb-0 text-white ">{{ \App\Models\Invoices::count() }}</h2>
                        </div>
                    ...
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ \App\Models\Invoices::where('status', '=', 'غير مدفوعه')->sum('total') }}</h4>
                            <h2 class="mb-0  text-white ">
                                {{ \App\Models\Invoices::where('status', '=', 'غير مدفوعه')->count() }} </h2>
                        </div>
                        <span class="float-right my-auto mr-auto">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <h2 class="mb-0  text-white ">
                                {{ \App\Models\Invoices::where('status', '=', 'مدفوعة')->count() }} </h2>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-up text-white"></i>
                        </span>
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <h2 class="mb-0  text-white ">
                                {{ \App\Models\Invoices::where('status', '=', 'مدفوعة جزئيا')->count() }} </h2>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-down text-white"></i>
                        </span>
...
<div class="row row-sm">
    <div class="col-md-12 col-lg-12 col-xl-7">
        <div class="card">
            ...
            <div class="card-body" style="width:64%;">
                {!! $chartjs->render() !!}
            </div>
        </div>
    </div>
