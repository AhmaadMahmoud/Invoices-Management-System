				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('unpaid') }}">الفواتير الغير مدفوعه</a></li>
                            @endcan
                            @can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='partial') }}">الفواتير المدفوعه جزئيا</a></li>
                            @endcan
						</ul>
					</li>
                    @can('التقارير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                            @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='customers') }}">تقارير العملاء</a></li>
                            @endcan
						</ul>
					</li>
                    @can('المستخدمين')
